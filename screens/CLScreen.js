                    ...
                    </View>
                    {
                        !this.state.loading ? (
                            <KeyboardAwareScrollView keyboardShouldPersistTaps='always' >
                                            ...
                                            <View style={styles.body}>
                                                ...
                                                <View style={{ alignItems: "center", height: "30%" }}>
                                                    <View style={styles.combo2}>
                                                        ...
                                                        <Text style={{ fontSize: normalize(20), right: normalize(35), padding: normalize(10), bottom: normalize(6) }}>p.a</Text>
                                                    </View>
                                                </View>
                                                <View style={{ alignItems: "center", height: "30%" }}>
                                                    <View style={styles.combo2}>
                                ...
                                <View style={{ marginTop: normalize(10), width: '100%', alignItems: "center" }}>
                                    {this.state.dispCalculation ? (
                                        <View style={{ alignItems: "center" }}>
                                            ...
                                            <View style={{ alignItems: "center", width: "100%", top: normalize(10), marginBottom: normalize(20) }}>
